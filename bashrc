...
# 2. Modified PS1 logic
if [ "$color_prompt" = yes ]; then
    # Added git prompt in yellow (\[\033[01;33m\]) before the final \$
...
# __git_ps1 is the function that injects the branch info
...
# Created by `pipx` on 2026-04-20 04:47:57
...
# git-new-branch <name> — checkout main, pull latest, create new branch from main
git-new-branch() {
  git checkout main && git pull origin main && git checkout -b "$1"
}
